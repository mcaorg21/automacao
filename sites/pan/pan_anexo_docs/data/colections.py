    ...
    return [
        {
            ...
            'texto': r'O conteúdo do campo Agência: é de preenchimento obrigatório.',
            'erro': "Agência selecionada não é permitida para Forma de Pagamento .",
            'mensagem': "Conferir dados do contrato",
            'observacao': "Problema na identificação da agência ou banco.",
            'tratamento': ['atualizar']
        }, {
            ...
            'texto': r"Cep \d{8} não Encontrado",
            'erro': "Erro encontrado: CEP não encontrado",
            'mensagem': "Reprovado a Conferir",
            'tratamento': ['atualizar']
        },{
