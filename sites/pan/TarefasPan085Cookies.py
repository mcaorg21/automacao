...
class TarefasPan085:
    ...
    timer: int = 60
    TITLE = 'Pan Todas Tarefas 085 Cookies'

    def __init__(self):
        self.chrome_user: str = PATHS.chrome_user('Pancred085Cookies')
        ...
        self.cookies_path = self.caminho_base+"\\pan\\cookies\\" + "usuario_085.pkl"
