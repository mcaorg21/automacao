...
PAGINA_PROCESSO_URL = 'https://www.omnifacil.com.br/pls/webdad/pck_sj_processo_juridico.consulta_acao?p_cod_acao_omni=3580512&p_nome=2614LARA&p_emp=2614&p_ide=|ID_SESSAO|&p_cpf=12738367666'
...
PAGINA_PROCESSO_URL_PERSONALIZADA = (
            ...
            '&p_nome=2614LARA&p_emp=2614&p_ide=|ID_SESSAO|&p_cpf=12738367666'
        )

EVENTOS = ['PDE', 'FSP', 'FTP', 'TRC', 'FPB', 'FTE', 'FBA']
OPTIONS_SELECT = {
...
URL_REGISTRO_DESPESA = "https://www.omnifacil.com.br/pls/webdad/pck_sj_despesa_utils.registro_despesa?P_NOME=2614LARA&P_EMP=2614&P_IDE=|ID_SESSAO|&P_CPF=12738367666"
...
def login_web_sistema(driver):
    ...
    try:
        ...
        pdb.set_trace()  # Debug: Verificar estado do login antes de solicitar MFA  
...
def registrar_despesa(driver, tarefa=None, valor_despesa=None, option_do_select_despesa=None, tipo_documento=None, documento=None):
    ...
    try:
        wait = WebDriverWait(driver, 10)
        pdb.set_trace()  # Debug: Verificar parâmetros recebidos pela função registrar_despesa
        ...
        campo_valor.clear()
        campo_valor.send_keys(str(valor_despesa))
...
def main():
    ...
    try:
        ...
        for idx, tarefa in enumerate(tarefas_validas, 1):
            ...
            if '3466246' in str(tarefa.get('pasta_numero_integracao')):
                continue
            ...
            try:             
                ...
                if 'FBA' in evento:
                    if 'ACORDO PÓS' in texto or 'ACORDO PRÉ' in texto:
                        ...
                        chave_tabela_valores = 'ACORDO'  # Debug: Verificar texto para FBA  
                ...
                if chave_tabela_valores != "":
                    ...
                    try:
                        ...
                        lista = tabela_valores[str(tarefa['contrato_cliente'])]['dados']
                        valor_despesa = next((v[chave_tabela_valores] for v in lista if chave_tabela_valores in v), None)
                        versao = str(tabela_valores[str(tarefa['contrato_cliente'])]['versao'] )
                        ...
                        if valor_despesa is not None:
                            ...
                            option_select_despesa = OPTIONS_SELECT[evento + '_V'+ versao]['p_cod_custo']
                            option_select_documento = OPTIONS_SELECT[evento + '_V'+ versao]['p_cod_tipo_documento']
                            input_tipo_documento = OPTIONS_SELECT[evento + '_V'+ versao]['tipo_documento']

                            pdb.set_trace()

                            registrar_despesa(driver, tarefa, valor_despesa, option_select_despesa, option_select_documento, input_tipo_documento)

                        else:
                            pdb.set_trace()  # Debug: Verificar o valor encontrado para definir a ação a ser tomada
