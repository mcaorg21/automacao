    ...
    if token:
        ...
        if tipo_titulo == False:
            ...
            for idx, tarefa in enumerate(tarefas_ordenadas, start=1):
                ...
                numero_processo = tarefa.get('processo_detalhes', [{}])[0].get('numero_processo')

                if '0010253-09.2026.8.05.0103' in numero_processo:
                    #pdb.set_trace() #numero de processo
                    continue

                #IFOOD #88 de grupo de trabalho
                if cliente_grupo_trabalho == 88:

                    # forcar_integracoes = ['IFOOD-111631','IFOOD-109595']
                    ...
                    print(f'  [{idx}/{len(tarefas_ordenadas)}] id_processo={id_processo} -> Grupo de trabalho não é 88, pulando busca por ATA.')
