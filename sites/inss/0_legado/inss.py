...
class Inss:
    ...
    def buscar_perfis(self):
        request_perfis = requests.get(
            f"https://app.emprestimofacil.com/index.php/api/v1/consultas/consultarMeuInss?perfil"
    ...
    def finaliza_consulta_info_falha(perfil, mensagem):
        ...
        request_dados_perfil = requests.post("https://app.emprestimofacil.com/index.php/api/v1/consultas"
    ...
    def finaliza_consulta_info_sucesso(self, perfil):
        ...
        request_dados_perfil = requests.post(
            "https://app.emprestimofacil.com/index.php/api/v1/consultas/inss", data=dados_post)
        print(request_dados_perfil.text)
