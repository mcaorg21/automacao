...
from sites.oleConsignado.ole_insercao.managers.ole_atualiza_in100 import OleConsigInssCem
...
class Main:
    ...
    TITLE = "Ole - Consulta In100"

    def __init__(self):
        self.base_path: str = PATHS.project_path()
        self.chrome_user: str = PATHS.chrome_user('OleIn100')
    ...
    def main(self):
        ...
        while True:
            try:
                definir_nome_robo(self.TITLE)
                OleConsigInssCem.iniciar_horario_comercial(self.driver)
    ...
    def aguardar_cookies(self):
        ...
        while self.driver.current_url.find("Home") == -1 and cnt < 50:
            try:
                ...
                print(e)
            print("Aguardando cookies do Olé...")
            self.driver.refresh()
            sleep(20)
            cnt += 1
