...
USER_PC: str = ('--user-data-dir=C:\\Users\\{}\\AppData\\'
                'Local\\Google\\Chrome\\OleConsig4'.format("gustavo"))
USER_SERV: str = '--user-data-dir=C:/Users/lucas.s/AppData/Local/Google/Chrome/User Ole 4'
...
def main():
    ...
    tarefa: object = OleConsignado(driver)
