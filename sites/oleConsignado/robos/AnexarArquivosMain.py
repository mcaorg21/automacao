"""
    Robô Anexar Arquivos Olé
"""
from selenium import webdriver
from selenium.webdriver.chrome.options import Options

from sites.oleConsignado.anexar_documentos import AnexarDocumentos
...
USER_PC: str = ('--user-data-dir=C:\\Users\\{}\\AppData\\'
                'Local\\Google\\Chrome\\OleConsig1'.format("gustavo"))
USER_SERV: str = '--user-data-dir=C:/Users/lucas.s/AppData/Local/Google/Chrome/User Ole 1'
...
def main():
    ...
    tarefa: object = AnexarDocumentos(driver)
