...
from sites.oleConsignado.ole_insercao.managers.ole_consig_insercao import OleConsig
...
USER_PC: str = ('--user-data-dir=C:\\Users\\{}\\AppData\\'
                'Local\\Google\\Chrome\\OleConsig5'.format("gustavo"))
USER_SERV: str = '--user-data-dir=C:/Users/lucas.s/AppData/Local/Google/Chrome/User Ole 6'
...
def main():
    ...
    tarefa: object = OleConsig(driver)
