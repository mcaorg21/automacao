"""
    Robô Consulta Refinanciamento Olé
"""
...
USER_PC: str = ('--user-data-dir=C:\\Users\\{}\\AppData\\'
                'Local\\Google\\Chrome\\OleConsig2'.format("gustavo"))
USER_SERV: str = '--user-data-dir=C:/Users/lucas.s/AppData/Local/Google/Chrome/User Ole 2'
...
def main():
    ...
    tarefa: object = ConsultaRefinanciamento(driver)
