...
class Consulta_Safra_Sinc():
    ...
    def __init__(self,driver):
        #self.path = '/home/viper/Documentos/automacao-python/sites/safra/pdfs/'
        # self.login = {'usuario': "CBSU148834", 'senha': 'Marcelo_909'}
        # self.agente = '07823888688'
        self.login = {'usuario': "CBSU154420", 'senha': 'Tim_909176'}
    ...
    def main(self):
        ...
        # self.driver.get('https://epfweb.safra.com.br/Home/Login')
        ...
        #         self.act.obter_propriedade('//*[@id="divLoadingLogin"]', 'display')
        #     except:
        #         break
        ...
        #         msg = "Subject: #####Problema -> Robo Safra##### \n\nTerceira tentativa de login feita no sincronização. Para corrigir o problema delete os cookies.".encode('utf-8')
        #         with smtplib.SMTP_SSL("smtp.gmail.com", port, context=context) as server:
        #             server.login("notifica4@uconecte.me", "marcelo2126")
        #             server.sendmail("notifica4@uconecte.me", "mcaorg@gmail.com", msg)
        #         sleep(10800)
        #         counter_login = 0
        # except:
        #     counter_login = 0
    ...
    def sincronizador(self):
        ...
        for i in dados[1:]:
            ...
            if status != 'Pago' and letra1 != 'P':
                ...
                texto_letra1 = self.act.obter_texto('/html/body/div[9]/div[2]/fieldset/p', By.XPATH)
                # botão X
                self.act.clicar_elemento('/html/body/div[9]/div[1]/button', By.XPATH)
            ...
            self.verificar_loading()
            titulo_letra2= self.act.obter_texto('/html/body/div[9]/div[1]/span', By.XPATH)
            url_bruta = None
            self.verificar_loading()
            try:
                quantidade_td = self.act.quantidade_elemento('/html/body/div[9]/div[2]/fieldset/table/tbody/tr', By.XPATH)
                d_textos = {}
            ...
            # STATUS
            self.act.clicar_elemento('/html/body/div[3]/div[2]/div[1]/div[2]/div/div[3]/div[3]/div/table/tbody/tr[2]/td[5]/span', By.XPATH)
            status += ' ' + self.act.obter_texto('/html/body/div[9]/div[2]/div/ul/li/ul/li', By.XPATH)
            status = status.split()
            try:
            ...
            self.verificar_loading()
            titulo_e = self.act.obter_texto('/html/body/div[9]/div[1]/span', By.XPATH)
            e_texto = self.act.obter_texto('/html/body/div[9]/div[2]/span', By.XPATH)
            self.act.clicar_elemento('/html/body/div[9]/div[1]/button', By.XPATH)
            # Principal
            ...
            payload = {
                ...
                "observacaoDetalhadaBanco": texto_observacao_banco,
